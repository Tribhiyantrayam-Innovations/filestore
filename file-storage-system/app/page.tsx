...
export default function HomePage() {
  ...
  const SMALL_FILE_THRESHOLD = 10 * 1024 * 1024 // 10MB - use chunked upload for files larger than this
  ...
  const handleUpload = async () => {
    ...
    try {
      for (let i = 0; i < files.length; i++) {
        ...
        try {
          // Use chunked upload for all files to avoid 413 errors
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="bg-white/10 backdrop-blur-xl border border-white/20 hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-white/70 text-sm">
                  All files uploaded in small chunks to prevent server limits and ensure reliability
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white/10 backdrop-blur-xl border border-white/20 hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
            ...
            <Card className="bg-white/10 backdrop-blur-xl border border-white/20 hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-white/70 text-small">Advanced encryption and multi-layer password protection</p>
              </CardContent>
            </Card>
          </div>
        </div>
